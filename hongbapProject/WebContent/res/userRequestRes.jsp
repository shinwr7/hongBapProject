...
<style>
    *{padding: 0; margin: 0;}
    .hr{width: 800px;}
    h2{padding: 10px;font: small-caps bold 24px/1 sans-serif; color: whitesmoke; background-color: rgb(212, 52, 12);width:700px; text-align: center; border-radius: 15px; }
